"""Generate a Big-O / cost summary table image for the TD3 article."""
...
ROWS = [
    ...
    ['Twin critic update',
     'O(B · W)',
     'O(W)',
     'target y = r + γ min(Q1\',Q2\')'],
    ['Actor update (delayed)',
     'O(B · W)',
     'O(W)',
     'every d steps; ascend Q1'],
    ['Soft-update targets',
     'O(W)',
     'O(W)',
     'delayed too; three target nets'],
    ...
    ['Total memory',
     '—',
     'O(W + N·d)',
     'six nets (actor, 2 critics, 3 targets)'],
]

COL_WIDTHS = [5.6, 3.3, 3.0, 6.3]
...
ax.text(TOTAL_W / 2 + 1.0, TABLE_H + 1.3,
        'Twin Delayed DDPG (TD3) Complexity',
...
ax.text(TOTAL_W / 2 + 1.0, Y0 - 0.45,
        ...
        'dim, delay d. A second critic and a min; the actor runs at half the rate.',
        fontsize=10, ha='center', va='center',
        color='#6B7280', fontfamily='sans-serif', fontstyle='italic')

plt.tight_layout()
out = ('D:/Projects/Medium/algorithms-in-python/'
       '09-advanced-reinforcement-learning/04-twin-delayed-ddpg/bigo_table.png')
