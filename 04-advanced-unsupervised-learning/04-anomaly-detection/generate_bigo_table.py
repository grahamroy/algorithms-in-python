"""Generate a Big-O / cost summary table image for the Anomaly Detection article."""
...
HEADERS = ['Detector', 'Fit', 'Score / point', 'Best for']
ROWS = [
    ['Mahalanobis distance',
     'O(n · d²)',
     'O(d²)',
     'low-d Gaussian data, baseline'],
    ['GMM log-likelihood',
     'O(I · n · K · d²)',
     'O(K · d²)',
     'multi-modal continuous data'],
    ['k-NN distance',
     'O(n · d)',
     'O(n · d)',
     'small-medium n, low-dim'],
    ...
    ['Isolation Forest',
     'O(T · n · log n)',
     'O(T · log n)',
     'production default; scales well'],
...
ax.text(TOTAL_W / 2 + 1.0, Y0 - 0.45,
        'n = data points, d = features, K = mixture components, '
        'T = trees, E = epochs, L = layers, I = iterations.',
...
out = ('D:/Projects/Medium/algorithms-in-python/'
       ...
       '04-anomaly-detection/bigo_table.png')
