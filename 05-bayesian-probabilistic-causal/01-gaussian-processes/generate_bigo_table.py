"""Generate a Big-O / cost summary table image for the GP article."""
...
ROWS = [
    ...
    ['Cholesky / inversion',
     'O(n³)',
     'O(n²)',
     'the bottleneck; numerically careful'],
    ['Predict mean, one point',
     'O(n)',
     'O(n)',
     'dot product against stored α = K⁻¹y'],
    ['Predict variance, one point',
     'O(n²)',
     'O(n²)',
     'requires the full K⁻¹'],
    ['Hyperparameter optimisation',
     'O(M · n³)',
     'O(n²)',
     'M steps × kernel-matrix recompute'],
    ['Sparse / variational GP',
     'O(n · m²)',
     'O(n · m)',
     'm ≪ n inducing points; scales to 10⁶'],
]

COL_WIDTHS = [5.4, 3.6, 2.8, 5.8]
...
ax.text(TOTAL_W / 2 + 1.0, Y0 - 0.45,
        'n = training points, d = features, M = hyper-opt steps, '
        'm = inducing points (sparse GP).',
...
out = ('D:/Projects/Medium/algorithms-in-python/'
       ...
       '01-gaussian-processes/bigo_table.png')
