"""Generate a Big-O / cost summary table image for the Q-Learning article."""
...
ROWS = [
    ...
    ['TD update (one step)',
     'O(|A|)',
     'O(1)',
     'max over next actions + one write'],
    ['One episode',
     'O(steps · |A|)',
     'O(1)',
...
ax.text(TOTAL_W / 2 + 1.0, Y0 - 0.45,
        ...
        'E = training episodes. The O(|S|·|A|) table is the scaling wall.',
        fontsize=10, ha='center', va='center',
        color='#6B7280', fontfamily='sans-serif', fontstyle='italic')

plt.tight_layout()
out = ('D:/Projects/Medium/algorithms-in-python/'
       '08-reinforcement-learning/01-q-learning/bigo_table.png')
