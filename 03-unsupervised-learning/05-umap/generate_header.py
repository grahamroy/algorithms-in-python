"""Generate the header image for the UMAP article."""
...
# --- Title and subtitle --------------------------------------------------
ax.text(8, 8.45, "UMAP: t-SNE's Faster, More Stable Successor",
        fontsize=18, fontweight='bold', ha='center', va='center',
        color=TEXT_COLOR, fontfamily='sans-serif')
ax.text(8, 7.95,
        'Same digits dataset, two non-linear projections side-by-side. UMAP wins on global structure.',
...
umap_proj = umap.UMAP(n_neighbors=15, min_dist=0.1,
                      random_state=7).fit_transform(X)
...
plot_proj(LEFT_PANEL, tsne_proj,
          't-SNE: clusters separate, positions arbitrary')
plot_proj(RIGHT_PANEL, umap_proj,
          'UMAP: clusters separate, positions meaningful')
