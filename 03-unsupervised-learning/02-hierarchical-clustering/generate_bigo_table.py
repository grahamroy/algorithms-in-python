"""Generate a Big-O / cost summary table image for the Hierarchical Clustering article."""
...
ROWS = [
    ...
    ['Naive agglomerative',
     'O(n³)',
     'O(n²)',
     'rescan all pairs every merge'],
    ['SLINK / CLINK / NN-chain',
     'O(n² log n)',
     'O(n²)',
    ...
    ['Cutting the dendrogram',
     'O(n)',
     'O(n)',
     'walk merge list to chosen height'],
    ['Predict for new point',
     'O(K · d)',
     '—',
     'no native support; usually nearest centroid'],
    ['Practical limit',
     'n ≈ 10⁴',
     'n² floats',
     'use HDBSCAN / BIRCH above this'],
]

COL_WIDTHS = [5.0, 3.6, 2.6, 5.6]
...
ax.text(TABLE_W / 2 + 1.0, caption_y,
        'n = data points, d = features, K = number of clusters '
        'after the dendrogram is cut.',
...
out_path = ('D:/Projects/Medium/algorithms-in-python/'
            ...
            '02-hierarchical-clustering/bigo_table.png')
